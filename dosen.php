                ...
                <div class="px-4 pt-6">
                    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
                        <div class="w-full mb-1">
                            <div class="mb-4">
                                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Data Dosen</h1>
                            </div>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                            ...
                                            ?>
                                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $row['alamat']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $row['no_telepon']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $row['email']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $row['jurusan']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $row['almamater']; ?></td>
                                                ...
                                                <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full" id="delete-user-modal<?= $no ?>">
                                                    <div class="relative w-full h-full max-w-md px-4 md:h-auto">
                                                        ...
                                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                            ...
                                                            <!-- Modal body -->
                                                            <form action="dosen_crud.php" method="POST">
                                                                ...
                                                                <form action="dosen_crud.php" method="POST">
                                                                    ...
                                                                    <div class="grid grid-cols-6 gap-2">
                                                                        ...
                                                                        <div class="col-span-6 sm:col-span-3">
                                                                            ...
                                                                            <input type="text" name="jurusan" id="jurusan" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="<?= $row['jurusan'] ?>" required>
                                                                        </div>
                                                                        <div class="col-span-6 sm:col-span-3">
                                                                            <label for="almamater" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Almamater</label>
                                                                            <input type="text" name="almamater" id="almamater" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="<?= $row['almamater'] ?>" required>
                                                                        </div>
                                                                    </div>
                                                            </div>
                                                            <!-- Modal footer -->
                                ...
                                <div class="p-6 space-y-6">
                                    <form action="dosen_crud.php" method="POST">
                                        <div class="grid grid-cols-6 gap-2">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="jurusan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jurusan</label>
                                                <input type="text" name="jurusan" id="jurusan" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Jurusan" required>
                                            </div>
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="almamater" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Almamater</label>
                                                <input type="text" name="almamater" id="almamater" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Almamater" required>
                                            </div>
                                        </div>
                                </div>
                                <!-- Modal footer -->
